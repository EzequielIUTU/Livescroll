-- LiveScroll 8 · Eliminación de cuenta V3
-- Limpia watch_sessions sin alterar tablas, claves ni funciones de LS6/LS7.
...
begin
  ...
  -- Esta relación no posee ON DELETE CASCADE en la base histórica.
  delete from public.watch_sessions where viewer_id=p_user_id;
