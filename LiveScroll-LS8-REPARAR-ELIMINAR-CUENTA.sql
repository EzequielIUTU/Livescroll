-- LiveScroll 8 · Reparación de eliminación administrativa de cuentas
...
begin
  ...
  -- Las relaciones de contenido se limpian por sus reglas ON DELETE CASCADE.
...
exception
  when foreign_key_violation then
    return jsonb_build_object('ok',false,'error','related_data_blocked','detail',sqlerrm);
  when others then
